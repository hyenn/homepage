  ...
  <TABLE>
    <TR>
      ...
      <TD>
      	...
      	type="email" name="email" placeholder="가입시 입력한 이메일을 입력하세요." size="35" required autofocus/>
      	<input class="w3-btn w3-white w3-border w3-border-green w3-round-large"
      	type="button" value="확인" onclick="searchId(document.frm.email.value.trim())">
      </TD>
    </TR>
  </TABLE>
